...
import { IconDrink } from "@/components/icons";
...
export default function FoodsPage() {
  ...
  return (
    <main className="pb-4">
      <PageHeader title="Aliments courants" backHref="/" backLabel="Accueil" />
      <div className="space-y-4 px-4 pt-3">
        ...
        <Link href="/add/drink" className="flex items-center gap-1.5 text-sm text-green-400">
          <IconDrink className="h-4 w-4 flex-shrink-0" aria-hidden />
